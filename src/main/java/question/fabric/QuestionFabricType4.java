...
public class QuestionFabricType4 extends QuestionFabric{

    public QuestionFabricType4(String pathToFolder) throws FileNotFoundException, WrongDataQuestionException {
